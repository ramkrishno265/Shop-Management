...
export default function SalePage() {
    ...
    useEffect(() => {
        // ফাংশনের নাম এবং ভেরিয়েবল নাম ঠিক করা হলো
        const fetchProducts = async () => {
            try {
                setLoading(true);
                const token = localStorage.getItem('token'); // ছোট হাতের 't'
                ...
                // কনসোলে চেক করার জন্য response.data ব্যবহার করুন
    ...
    const addToCart = (product) => {
        // চেক করা হচ্ছে প্রোডাক্টটি অলরেডি কার্টে আছে কি না
        const existingItem = cart.find(item => item.id === product.id);

        if (existingItem) {
            // থাকলে শুধু কোয়ান্টিটি ১ বাড়িয়ে দেওয়া
            updateQuantity(product.id, 1);
        } else {
            // না থাকলে নতুন অবজেক্ট হিসেবে যোগ করা
            setCart([...cart, { ...product, price: product.sellingPrice, quantity: 1 }]);
        }
        setSearchQuery(''); // ইনপুট খালি করে দেওয়া
        setShowResults(false); // ড্রপডাউন বন্ধ করে দেওয়া
    };
    ...
    // কোয়ান্টিটি বাড়ানো বা কমানোর ফাংশন
    ...
    const handleCheckout = (e) => {
        ...
        alert(`🎉 বিল সফলভাবে জেনারেট হয়েছে!\nসর্বমোট: ৳${payableAmount}\nপেমেন্ট মেথড: ${paymentMethod}`);
        // এখানে পরবর্তীতে আপনার ব্যাকএন্ড এপিআই কল হবে (axios.post)
    };
    ...
    return (
        <div className="p-1 text-slate-900">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* 🛒 বাম পাশের কলাম: প্রোডাক্ট সার্চ ও কার্ট লিস্ট (৬৬% উইডথ) */}
                <div className="lg:col-span-2 space-y-5">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs flex gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    setShowResults(e.target.value.length > 0); // কিছু লিখলেই রেজাল্ট দেখাবে
                                }}
                            />
                                    ...
                                    {products
                                        ...
                                        .map((product) => (
                                            <div
                                                ...
                                                onClick={() => {
                                                    setSearchQuery(product.name); // সিলেক্ট করলে ইনপুটে নাম বসবে
                                                    setShowResults(false); // ড্রপডাউন বন্ধ হয়ে যাবে
                                                    // এখানে চাইলে আপনি সিলেক্ট করা প্রোডাক্টটি কোনো একটি স্টেটে সেভ করে রাখতে পারেন
                                                }}
                                            >
                                                <div>
                        ...
                        <button
                            onClick={() => {
                                // সার্চ রেজাল্ট থেকে প্রথম ম্যাচ হওয়া প্রোডাক্টটি কার্টে যোগ হবে
                ...
                {/* 💳 ডান পাশের কলাম: কাস্টমার সিলেকশন ও বিল সামারি (৩৩% উইডথ) */}
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mt-1.5">
                                ...
                                <button
                                    ...
                                    onClick={() => alert("নতুন কাস্টমার ক্রিয়েট মোডাল")}
                                >
                                    ➕
                                </button>
                            </div>

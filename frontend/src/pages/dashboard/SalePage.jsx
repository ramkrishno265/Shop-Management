...
export default function SalePage() {
    ...
    // -------------------------------------------------------------
    // ৩. ইভেন্ট হ্যান্ডলার ও লজিক ফাংশনসমূহ
    // -------------------------------------------------------------
    ...
    const handleCheckout = async (e) => {
        ...
        // ব্যাকএন্ডে পাঠানোর জন্য ডাটার অবজেক্ট তৈরি
        const orderData = {
        ...
        try {
            ...
            // ব্যাকএন্ডে পোস্ট রিকোয়েস্ট পাঠানো
            ...
            alert(`🎉 বিল ও সেল সফলভাবে সেভ হয়েছে!\nইনভয়েস আইডি: ${response.data.invoiceNo || 'N/A'}\nসর্বমোট: ৳${payableAmount}`);

            // সফলভাবে সেভ হওয়ার পর কার্ট ও পেমেন্ট ফিল্ড খালি করে দেওয়া
            setCart([]);
            setDiscount(0);
            setReceivedAmount('');
            ...
            alert(err.response?.data?.message || "❌ সেল প্রসেস করতে সমস্যা হয়েছে। আবার চেষ্টা করুন।");
        }
    };

    // -------------------------------------------------------------
    // ৪. হিসাব-নিকাশ (Calculations)
    // -------------------------------------------------------------
